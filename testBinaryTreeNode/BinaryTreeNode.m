...
#pragma mark -
#pragma mark 创建二叉排序树 (二叉排序树：左节点值全部小于根节点值，右节点值全部大于根节点值)
...
#pragma mark -
#pragma mark 先序遍历 (先访问根，再遍历左子树，再遍历右子树)
...
#pragma mark -
#pragma mark 中序遍历 (先遍历左子树，再访问根，再遍历右子树)
...
#pragma mark -
#pragma mark 后序遍历 (先遍历左子树，再遍历右子树，再访问根)
...
#pragma mark -
#pragma mark 层次遍历（广度优先:按照从上到下、从左到右的次序进行遍历。先遍历完一层，再遍历下一层，因此又叫广度优先遍历）
/**
...
#pragma mark -
#pragma mark 二叉树的深度 (二叉树的深度定义为：从根节点到叶子结点依次经过的结点形成树的一条路径,最长路径的长度为树的深度。)
/**
...
#pragma mark -
#pragma mark 二叉树的宽度 (二叉树的宽度定义为各层节点数的最大值)
/**
 二叉树的宽度定义为各层节点数的最大值
 */
...
#pragma mark -
#pragma mark 二叉树的所有节点数 (二叉树所有节点数=左子树节点数+右子树节点数+1)
/**
...
#pragma mark -
#pragma mark 二叉树某层中的节点数 (二叉树第k层节点数=左子树第k-1层节点数+右子树第k-1层节点数)
/**
 1）根节点为空，则节点数为0；
...
#pragma mark -
#pragma mark 二叉树叶子节点数 (叶子节点，又叫终端节点，是左右子树都是空的节点。)
/**
...
#pragma mark -
#pragma mark 二叉树最大距离（直径:二叉树中任意两个节点都有且仅有一条路径，这个路径的长度叫这两个节点的距离。二叉树中所有节点之间的距离的最大值就是二叉树的直径）
/**
...
#pragma mark -
#pragma mark 是否完全二叉树 （完全二叉树定义为：若设二叉树的高度为h，除第h层外，其它各层的结点数都达到最大个数，第h层有叶子结点，并且叶子结点都是从左到右依次排布。）
/**
...
#pragma mark -
#pragma mark 是否满二叉树 （满二叉树：除了叶结点外每一个结点都有左右子叶且叶子结点都处在最底层的二叉树）
/**
...
#pragma mark -
#pragma mark 是否平衡二叉树 （平衡二叉树：即AVL树，它是一棵空树或它的左右两个子树的高度差的绝对值不超过1，并且左右两个子树都是一棵平衡二叉树）
/**
...
+ (BinaryTreeNode *)MaxBinaryTree:(BinaryTreeNode *)rootNode{
    ...
    return [self MaxBinaryTree:rootNode.rightNode];
}
